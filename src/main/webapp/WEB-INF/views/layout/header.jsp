...
<link href="css/companyedit.css" rel="stylesheet">
<link href="css/like.css" rel="stylesheet">
<link href="css/serviceout.css" rel="stylesheet">
	...
	<header class="header">
		<div class="header_inner">
			...
			<ul class="login">
				...
				<li class="profile"><a href="#">프로필</a>
					<ul class="profile_list">
						...
						<li><a class="profile_item" href="like">좋아요</a></li>
			...
			<ul class="companyservice">
				<li><a href="companys">기업 서비스</a></li>
			</ul>
		</div>
	</header>